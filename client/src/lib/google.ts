...
export class GoogleBusinessService {
    ...
    async fetchLocations(_accountId: string) {
        return [];
    }
    ...
    async fetchReviews(_accountId: string, locationId: string) {
    ...
    async replyToReview(_accountId: string, _locationId: string, reviewId: string, comment: string) {
